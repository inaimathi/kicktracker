  ...
  (pg/html5
   ...
   [:body
    ...
    [:ul 
     ...
     [:li [:a {:href "/board-games"} [:b [:code "/board-games"]]] " - covers most of the things I'm interested in. It's a combination of searches for \"tabletop game\", \"board game\" and category #34"]
